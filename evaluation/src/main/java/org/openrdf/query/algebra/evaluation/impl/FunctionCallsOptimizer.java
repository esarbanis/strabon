...
//import org.openrdf.query.algebra.evaluation.function.spatial.AnyInteractFunc;
...
//			
//			if(function instanceof AnyInteractFunc)
//			{
//				ValueExpr left = args.get(0);
//				ValueExpr right = args.get(1);
//		
//				//PgSqlExprSupport.anyInteract(left,right);
//			}
////FIXME this must be fixed			
////			SpatialTopoOperator operator;
////			if(function instanceof AnyInteractFunc)
////				operator = new AnyInteract(args.get(0),args.get(1));
