 ...
 * 
 */
public class H2SqlTable extends GeneralDBSqlTable {

  /**
   * This value should not be changed whatever the semantics of Strabon is for EPSG:4326. This
   * number is hardcoded in PostGIS's SQL statements that define several of their ST_ methods.
   */
  public static final int DEFAULT_SRID = 4326;

  public H2SqlTable(String name) {
  ...
  public String buildGeometryCollumn() {
    return "SELECT AddGeometryColumn('', 'geo_values', 'strdfgeo', " + DEFAULT_SRID
        + ", 'GEOMETRY', 2)";
  }
  ...
  /**
   * SQL arguments arg1: hash arg2: geometry (binary) arg3: SRID of the given geometry (used to
   * transform it to PostGIS' 4326 long/lat CRS) arg4: SRID of the given geometry to save to the
   * database
   */
  @Override
