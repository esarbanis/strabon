...
public class MonetDBEvaluation extends GeneralDBEvaluation {
  ...
  private static Logger logger = LoggerFactory
      .getLogger(org.openrdf.sail.monetdb.evaluation.MonetDBEvaluation.class);

  public MonetDBEvaluation(GeneralDBQueryBuilderFactory factory, GeneralDBTripleRepository triples,
