...
public class MonetDBSqlBracketBuilder extends MonetDBSqlExprBuilder implements
  ...
  public MonetDBSqlBracketBuilder(GeneralDBSqlExprBuilder where,
      GeneralDBQueryBuilderFactory factory) {
    super(factory);
