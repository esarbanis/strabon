...
sudo -u postgres createdb ${DB} -T template_postgis
...
#            read a
            ...
            # deleteSeaHotspots
            echo -n "Going to deleteSeaHotspots 2007-08-25T${time2}:00 " ;echo; echo; echo;
...
#            read a
            ...
            echo -n "refinePartialSeaHotspots 2007-08-25T${time2}:00 "  ; echo; echo ; echo;
...
#            read a
            ...
            echo -n "Going to refineTimePersistence 2007-08-25T${time2}:00 ";echo;echo;echo; 
