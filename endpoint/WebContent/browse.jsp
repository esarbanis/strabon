        ...
        <TD height="60" background="images/nav2_bg.gif">
            <table width="100%" border=0>
                <tr>
                    ...
                    <td valign="top" width="50px"><a href="query.jsp"><img border="0"
                                                                           src="images/teleios_logo.png"/></a>
                    </td>
                    <td valign="top" align="left">
                        <span class="logo"><a href="query.jsp">&nbsp;stSPARQL
                            Endpoint</a></span><br><span class="style4"></span></td>
                </tr>
            </table>
        </TD>
    </TR>
