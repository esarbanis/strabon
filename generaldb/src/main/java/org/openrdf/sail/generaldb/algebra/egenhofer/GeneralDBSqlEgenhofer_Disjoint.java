...
public class GeneralDBSqlEgenhofer_Disjoint extends GeneralDBSqlGeoSpatial{

	public GeneralDBSqlEgenhofer_Disjoint(GeneralDBSqlExpr left, GeneralDBSqlExpr right) {
		super(left, right);
	}
