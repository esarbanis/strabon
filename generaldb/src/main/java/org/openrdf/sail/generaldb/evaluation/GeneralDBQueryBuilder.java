...
public abstract class GeneralDBQueryBuilder {
  ...
  public GeneralDBQueryBuilder filter(GeneralDBColumnVar var, Value val) throws RdbmsException {
  ...
  protected void dispatchBinarySqlOperator(BinaryGeneralDBOperator expr,
      GeneralDBSqlExprBuilder filter) throws UnsupportedRdbmsOperatorException {
  ...
  protected void dispatchTripleSqlOperator(TripleGeneralDBOperator expr,
      GeneralDBSqlExprBuilder filter) throws UnsupportedRdbmsOperatorException {
  ...
  protected void dispatchUnarySqlOperator(UnaryGeneralDBOperator expr,
      GeneralDBSqlExprBuilder filter) throws UnsupportedRdbmsOperatorException {
  ...
  protected void dispatchValueColumnBase(GeneralDBValueColumnBase expr,
      GeneralDBSqlExprBuilder filter) throws UnsupportedRdbmsOperatorException {
  ...
  protected void join(GeneralDBSqlJoinBuilder query, GeneralDBFromItem join) throws RdbmsException,
  ...
  protected abstract GeneralDBSqlJoinBuilder subJoinAndFilter(GeneralDBSqlJoinBuilder query,
  ...
  // Egenhofer
  protected abstract void append(GeneralDBSqlEgenhofer_CoveredBy expr,
      GeneralDBSqlExprBuilder filter) throws UnsupportedRdbmsOperatorException;
  ...
  protected abstract void appendRelate(BinaryGeneralDBOperator expr,
