...
public class GeneralDBSqlEgenhofer_Inside extends GeneralDBSqlGeoSpatial{

	public GeneralDBSqlEgenhofer_Inside(GeneralDBSqlExpr left, GeneralDBSqlExpr right) {
		super(left, right);
	}
