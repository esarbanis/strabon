...
public class LiteralTable {
  ...
  private static Logger logger = LoggerFactory
      .getLogger(org.openrdf.sail.generaldb.schema.LiteralTable.class);
  ...
  public void insertLanguage(Number id, String label, String language) throws SQLException,
      InterruptedException {
    insertSimple(id, label);
    languages.insert(id, language);
  }

  public void insertDatatype(Number id, String label, String datatype) throws SQLException,
      InterruptedException {
  ...
  public void insertWKT(Number id, String label, String datatype, Timestamp start, Timestamp end)
      throws SQLException, NullPointerException, InterruptedException, IllegalArgumentException {
    try {
   ...
   */
  public void insertGML(Number id, String gml, String datatype, Timestamp start, Timestamp end)
      throws SQLException, NullPointerException, InterruptedException, IllegalArgumentException {
    Geometry geom;
    try {
      geom = JTSWrapper.getInstance().GMLread(gml);
      geoSpatialTable.insert(id, geom.getSRID(),/* start,end, */
          JTSWrapper.getInstance().WKBwrite(geom));
