...
public class GeneralDBSelectQuery extends GeneralDBQueryModelNodeBase implements TupleExpr {
  ...
  private Map<String, GeneralDBSelectProjection> projections =
      new HashMap<String, GeneralDBSelectProjection>();
  ...
  public <X extends Exception> void visitChildren(QueryModelVisitor<X> visitor) throws X {
    ...
    from.visit(visitor);
    ArrayList<GeneralDBSelectProjection> list =
        new ArrayList<GeneralDBSelectProjection>(projections.values());
