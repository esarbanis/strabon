 ...
 * value column. PLUS: strdfgeo column, constraint column
 */
public class GeoValueTable {
   ...
   * @param originalSRID the official SRID of this geometry (e.g., EPSG:4326 lat/long, the custom
   *        66666 WGS84 long/lat)
   * 
   * @throws SQLException
   * @throws InterruptedException
   * @throws NullPointerException
   */
  public synchronized void insert(Number id, Integer srid,/*
                                                           * String constraint, Timestamp
                                                           * interval_start, Timestamp interval_end,
                                                           */byte[] geom) throws SQLException,
  ...
  /**
   * FIXME careful here CURRENT FIELDS: id, value (byte[] form of Polyhedron, strdfgeo(wkt version
   * of Polyhedron)
   */
