...
public abstract class UnaryGeneralDBOperator extends GeneralDBQueryModelNodeBase implements
  ...
  private static Logger logger = LoggerFactory
      .getLogger(org.openrdf.sail.generaldb.algebra.base.UnaryGeneralDBOperator.class);
  ...
  public void replaceChildNode(QueryModelNode current, QueryModelNode replacement) {
    if (arg == current) {
      ...
      if (logger.isWarnEnabled()) {
        logger
            .warn("[Strabon.GeneralDB] The next call will blow things up. I'll try to suppress it, but notify me in case anything goes wrong.");
      }
