...
public class GeneralDBSqlConstantOptimizer extends GeneralDBQueryModelVisitorBase<RuntimeException>
  ...
  @Override
  public void meet(GeneralDBSqlAnd node) throws RuntimeException {
    super.meet(node);
  ...
  @Override
  public void meet(GeneralDBSqlCase node) throws RuntimeException {
    super.meet(node);
  ...
  @Override
  public void meet(GeneralDBSqlCompare node) throws RuntimeException {
    super.meet(node);
    GeneralDBSqlExpr left = node.getLeftArg();
    GeneralDBSqlExpr right = node.getRightArg();
  ...
  @Override
  public void meet(GeneralDBSqlConcat node) throws RuntimeException {
    super.meet(node);
    GeneralDBSqlExpr left = node.getLeftArg();
    GeneralDBSqlExpr right = node.getRightArg();
  ...
  @Override
  public void meet(GeneralDBSqlEq node) throws RuntimeException {
    super.meet(node);
    GeneralDBSqlExpr left = node.getLeftArg();
    GeneralDBSqlExpr right = node.getRightArg();
    if (left instanceof GeneralDBSqlNull || right instanceof GeneralDBSqlNull) {
  ...
  @Override
  public void meet(GeneralDBSqlIsNull node) throws RuntimeException {
    super.meet(node);
  ...
  @Override
  public void meet(GeneralDBSqlLowerCase node) throws RuntimeException {
    super.meet(node);
  ...
  @Override
  public void meet(GeneralDBSqlNot node) throws RuntimeException {
    super.meet(node);
    GeneralDBSqlExpr arg = node.getArg();
  ...
  @Override
  public void meet(GeneralDBSqlOr node) throws RuntimeException {
    super.meet(node);
    GeneralDBSqlExpr left = node.getLeftArg();
    GeneralDBSqlExpr right = node.getRightArg();
  ...
  private GeneralDBSqlExpr other(GeneralDBSqlExpr node, GeneralDBSqlExpr compare,
      Class<? extends BinaryGeneralDBOperator> type) {
    if (type.isInstance(node)) {
