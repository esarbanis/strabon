...
public class GeneralDBLabelExprFactory extends
  ...
  public GeneralDBSqlExpr createLabelExpr(ValueExpr expr) throws UnsupportedRdbmsOperatorException {
    result = null;
    if (expr == null)
  ...
  private GeneralDBSqlExpr uri(ValueExpr arg) throws UnsupportedRdbmsOperatorException {
    return sql.createUriExpr(arg);
  }

  private GeneralDBSqlExpr num(ValueExpr arg) throws UnsupportedRdbmsOperatorException {
