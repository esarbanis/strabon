...
public class GeneralDBSqlExprFactory {
  ...
  public GeneralDBSqlExpr createBNodeExpr(ValueExpr arg) throws UnsupportedRdbmsOperatorException {
    return bnode.createBNodeExpr(arg);
  }

  public GeneralDBSqlExpr createBooleanExpr(ValueExpr arg) throws UnsupportedRdbmsOperatorException {
    return bool.createBooleanExpr(arg);
  }

  public GeneralDBSqlExpr createLabelExpr(ValueExpr arg) throws UnsupportedRdbmsOperatorException {
  ...
  public GeneralDBSqlExpr createNumericExpr(ValueExpr arg) throws UnsupportedRdbmsOperatorException {

    return numeric.createNumericExpr(arg);
  }

  public GeneralDBSqlExpr createTimeExpr(ValueExpr arg) throws UnsupportedRdbmsOperatorException {
    return time.createTimeExpr(arg);
  }

  public GeneralDBSqlExpr createZonedExpr(ValueExpr arg) throws UnsupportedRdbmsOperatorException {
  ...
  public GeneralDBSqlExpr createUriExpr(ValueExpr arg) throws UnsupportedRdbmsOperatorException {
    return uri.createUriExpr(arg);
  }

  public GeneralDBSqlExpr createHashExpr(ValueExpr arg) throws UnsupportedRdbmsOperatorException {
