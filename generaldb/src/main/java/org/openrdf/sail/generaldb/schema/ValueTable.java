...
public class ValueTable {
  ...
  public void initialize() throws SQLException {
    ...
    if (!table.isCreated()) {
      ...
      if (this.getName().equalsIgnoreCase("datetime_values")
          || this.getName().equalsIgnoreCase("hash_values")) {
  ...
  public synchronized void insert(Number id, String value) throws SQLException,
  ...
  public synchronized void insert(Number id, Number value) throws SQLException,
      InterruptedException {
    ValueBatch batch = getValueBatch();
    if (isExpired(batch)) {
      batch = newValueBatch();
