...
public class XMLGSDatatypeUtil {
  ...
  /**
   * Returns true when the given value is an instance of class @{link GeneralDBPolyhedron} or @{link
   * Literal} with datatype @{link StrabonPolyhedron#ogcGeometry} (WKT) or
   * 
  ...
  /**
   * Returns true when the given literal has as datatype the WKT URI as it is in @{link
   * StrabonPolyhedron.WKT}.
   * 
   * @param literal
   * @return
   */
  ...
  /**
   * Returns true when the given literal has as datatype the GML URI as it is in @{link
   * StrabonPolyhedron.GML}.
   * 
   * @param literal
   * @return
   */
  ...
  public static boolean containsWKTGeometry(Literal literal) {
    return literal.stringValue().contains(WKTConstants.WKTPOINT)
  ...
  public static boolean isPrimitiveDatatype(URI datatype) {
    return XMLSchema.DURATION.equals(datatype) || XMLSchema.DATETIME.equals(datatype)
        || XMLSchema.TIME.equals(datatype) || XMLSchema.DATE.equals(datatype)
        || XMLSchema.GYEARMONTH.equals(datatype) || XMLSchema.GYEAR.equals(datatype)
        || XMLSchema.GMONTHDAY.equals(datatype) || XMLSchema.GDAY.equals(datatype)
        || XMLSchema.GMONTH.equals(datatype) || XMLSchema.STRING.equals(datatype)
        || XMLSchema.BOOLEAN.equals(datatype) || XMLSchema.BASE64BINARY.equals(datatype)
        || XMLSchema.HEXBINARY.equals(datatype) || XMLSchema.FLOAT.equals(datatype)
        || XMLSchema.DECIMAL.equals(datatype) || XMLSchema.DOUBLE.equals(datatype)
        || XMLSchema.ANYURI.equals(datatype) || XMLSchema.QNAME.equals(datatype)
  ...
  public static boolean isDerivedDatatype(URI datatype) {
    return XMLSchema.NORMALIZEDSTRING.equals(datatype) || XMLSchema.TOKEN.equals(datatype)
        || XMLSchema.LANGUAGE.equals(datatype) || XMLSchema.NMTOKEN.equals(datatype)
        || XMLSchema.NMTOKENS.equals(datatype) || XMLSchema.NAME.equals(datatype)
        || XMLSchema.NCNAME.equals(datatype) || XMLSchema.ID.equals(datatype)
        || XMLSchema.IDREF.equals(datatype) || XMLSchema.IDREFS.equals(datatype)
        || XMLSchema.ENTITY.equals(datatype) || XMLSchema.ENTITIES.equals(datatype)
        || XMLSchema.INTEGER.equals(datatype) || XMLSchema.LONG.equals(datatype)
        || XMLSchema.INT.equals(datatype) || XMLSchema.SHORT.equals(datatype)
        || XMLSchema.BYTE.equals(datatype) || XMLSchema.NON_POSITIVE_INTEGER.equals(datatype)
        || XMLSchema.NEGATIVE_INTEGER.equals(datatype)
        || XMLSchema.NON_NEGATIVE_INTEGER.equals(datatype)
        || XMLSchema.POSITIVE_INTEGER.equals(datatype) || XMLSchema.UNSIGNED_LONG.equals(datatype)
        || XMLSchema.UNSIGNED_INT.equals(datatype) || XMLSchema.UNSIGNED_SHORT.equals(datatype)
   ...
   * that is derived from xsd:decimal.
   */
  public static boolean isDecimalDatatype(URI datatype) {
    return XMLSchema.DECIMAL.equals(datatype) || isIntegerDatatype(datatype);
  }

  /**
   * Checks whether the supplied datatype is equal to xsd:integer or one of the built-in datatypes
   * that is derived from xsd:integer.
   */
  public static boolean isIntegerDatatype(URI datatype) {
    return XMLSchema.INTEGER.equals(datatype) || XMLSchema.LONG.equals(datatype)
        || XMLSchema.INT.equals(datatype) || XMLSchema.SHORT.equals(datatype)
        || XMLSchema.BYTE.equals(datatype) || XMLSchema.NON_POSITIVE_INTEGER.equals(datatype)
        || XMLSchema.NEGATIVE_INTEGER.equals(datatype)
        || XMLSchema.NON_NEGATIVE_INTEGER.equals(datatype)
  ...
  public static boolean isFloatingPointDatatype(URI datatype) {
    return XMLSchema.FLOAT.equals(datatype) || XMLSchema.DOUBLE.equals(datatype);
  }

  /**
   * Checks whether the supplied datatype is equal to xsd:dateTime, xsd:date, xsd:time,
   * xsd:gYearMonth, xsd:gMonthDay, xsd:gYear, xsd:gMonth or xsd:gDay. These are the primitive
   * datatypes that represent dates and/or times.
   * 
   * @see XMLGregorianCalendar
   */
  public static boolean isCalendarDatatype(URI datatype) {
    return XMLSchema.DATETIME.equals(datatype) || XMLSchema.DATE.equals(datatype)
        || XMLSchema.TIME.equals(datatype) || XMLSchema.GYEARMONTH.equals(datatype)
        || XMLSchema.GMONTHDAY.equals(datatype) || XMLSchema.GYEAR.equals(datatype)
        || XMLSchema.GMONTH.equals(datatype) || XMLSchema.GDAY.equals(datatype);
