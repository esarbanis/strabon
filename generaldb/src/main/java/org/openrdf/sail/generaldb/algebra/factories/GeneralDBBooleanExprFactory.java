...
import org.openrdf.query.algebra.evaluation.function.spatial.stsparql.construct.*;
...
public class GeneralDBBooleanExprFactory extends
  ...
  private static final Logger logger = LoggerFactory
      .getLogger(org.openrdf.sail.generaldb.algebra.factories.GeneralDBBooleanExprFactory.class);
  ...
  /**
   * XXX Additions here to support metrics
   */
  @Override
    ...
    switch (op) {
      ...
      case LT:
        ...
        if ((!rightIsSpatial && !rightIsDateTime) && (!leftIsSpatial && !leftIsDateTime)) {
          ...
          /**
           * In case you need to remove the operations involving MOD, use the following line for
           * datetime instead:
           */
  ...
  public void meet(FunctionCall functionCall) throws UnsupportedRdbmsOperatorException {
    ...
    if (function instanceof SpatialConstructFunc) {
      ...
      if (!(function instanceof EnvelopeFunc) && !(function instanceof ConvexHullFunc)
          && !(function instanceof BoundaryFunc) && !(function instanceof GeoSparqlBoundaryFunc)
...

      {
        ...
        if (right instanceof FunctionCall) {
          ...
          if (function.getURI().equals(GeoConstants.stSPARQLbuffer)) {
            ...
            // DEFAULT behavior for constructs! buffer's second argument is a ValueConstant or a
            // Var,
  ...
  public GeneralDBSqlExpr spatialFunction(FunctionCall functionCall)
      throws UnsupportedRdbmsOperatorException {
    Function function = FunctionRegistry.getInstance().get(functionCall.getURI());
    if (function instanceof SpatialConstructFunc) {
   ...
   */
  GeneralDBSqlExpr spatialRelationshipFunction(FunctionCall functionCall, Function function)
      throws UnsupportedRdbmsOperatorException {
    ValueExpr left = functionCall.getArgs().get(0);
    ValueExpr right = functionCall.getArgs().get(1);
   ...
   * TODO check required number of arguments
   */
  GeneralDBSqlExpr spatialConstructFunction(FunctionCall functionCall, Function function)
      throws UnsupportedRdbmsOperatorException {
    GeneralDBSqlExpr leftArg = null;
    GeneralDBSqlExpr rightArg = null;
    GeneralDBSqlExpr thirdArg = null;
    ...
    if (!(function instanceof EnvelopeFunc) && !(function instanceof ConvexHullFunc)
        && !(function instanceof BoundaryFunc) && !(function instanceof GeoSparqlBoundaryFunc)
        && !(function instanceof GeoSparqlConvexHullFunc)
        && !(function instanceof GeoSparqlEnvelopeFunc) && !(function instanceof Centroid)
      ...
      if (right instanceof FunctionCall) {
        ...
        if (function.getURI().equals(GeoConstants.stSPARQLbuffer)
            || function.getURI().equals(GeoConstants.geoSparqlBuffer)) {
          // Be it a Var or a Value Constant, 'numeric' is the way to go
          rightArg = numeric(right);
        } else if (function.getURI().equals(GeoConstants.stSPARQLtransform)) {
          // Another special case -> Second argument of this function is a URI
   ...
   * TODO check required number of arguments
   */
  GeneralDBSqlExpr spatialMetricFunction(FunctionCall functionCall, Function function)
      throws UnsupportedRdbmsOperatorException {
    GeneralDBSqlExpr leftArg = null;
    GeneralDBSqlExpr rightArg = null;
    GeneralDBSqlExpr thirdArg = null;
  ...
  GeneralDBSqlExpr spatialPropertyFunction(FunctionCall functionCall, Function function)
      throws UnsupportedRdbmsOperatorException {
  ...
  GeneralDBSqlExpr spatialRelationshipPicker(Function function, GeneralDBSqlExpr leftArg,
      GeneralDBSqlExpr rightArg, GeneralDBSqlExpr thirdArg) {
    // XXX stSPARQL
    ...
    logger
        .error(
            "[Strabon.spatialRelationshipPicker] No appropriate SQL expression was generated for extension function {}. This is probably a bug.",
            function.getURI());
    return null;
  }
   ...
   */
  GeneralDBSqlExpr spatialConstructPicker(Function function, GeneralDBSqlExpr leftArg,
      GeneralDBSqlExpr rightArg, GeneralDBSqlExpr thirdArg) {
    ...
    logger
        .error(
            "[Strabon.spatialConstructPicker] No appropriate SQL expression was generated for extension function {}. This is probably a bug.",
            function.getURI());
    return null;
  }
  ...
  GeneralDBSqlExpr dateTimeMetricPicker(Function function, GeneralDBSqlExpr leftArg,
    ...
    logger
        .error(
            "[Strabon.dateTimeMetricPicker] No appropriate SQL expression was generated for extension function {}. This is probably a bug.",
            function.getURI());
    return null;
  }

  /**
   * TODO check required number of arguments FIXME don't check function using getURI(); use
   * instanceof instead
   */
  GeneralDBSqlExpr spatialMetricPicker(Function function, GeneralDBSqlExpr leftArg,
      GeneralDBSqlExpr rightArg, GeneralDBSqlExpr thirdArg) {
    ...
    logger
        .error(
            "[Strabon.spatialMetricPicker] No appropriate SQL expression was generated for extension function {}. This is probably a bug.",
            function.getURI());
    return null;
  }
  ...
  GeneralDBSqlExpr spatialPropertyPicker(Function function, GeneralDBSqlExpr arg) {
    ...
    logger
        .error(
            "[Strabon.GeneralDBBooleanExprFactory] No appropriate SQL expression was generated for extension function {}. This is probably a bug.",
            function.getURI());
