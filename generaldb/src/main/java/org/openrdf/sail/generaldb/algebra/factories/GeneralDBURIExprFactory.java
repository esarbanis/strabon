...
public class GeneralDBURIExprFactory extends
  ...
  public GeneralDBSqlExpr createUriExpr(ValueExpr expr) throws UnsupportedRdbmsOperatorException {
    result = null;
    if (expr == null)
  ...
  private GeneralDBSqlExpr label(ValueExpr arg) throws UnsupportedRdbmsOperatorException {
    return sql.createLabelExpr(arg);
  }

  private GeneralDBSqlExpr lang(ValueExpr arg) throws UnsupportedRdbmsOperatorException {
    return sql.createLanguageExpr(arg);
  }

  private GeneralDBSqlExpr type(ValueExpr arg) throws UnsupportedRdbmsOperatorException {
