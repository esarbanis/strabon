...
public class GeneralDBNumericExprFactory extends
  ...
  /**
   * Addition in order to be able to transform the metric expressions I need I also needed to create
   * uri expressions
   */
  ...
  public void meet(MathExpr node) throws UnsupportedRdbmsOperatorException {
    ...
    if (node.getLeftArg() instanceof FunctionCall) {
      Function function =
          FunctionRegistry.getInstance().get(((FunctionCall) node.getLeftArg()).getURI());
    ...
    if (node.getRightArg() instanceof FunctionCall) {
      Function function =
          FunctionRegistry.getInstance().get(((FunctionCall) node.getRightArg()).getURI());
  ...
  private GeneralDBSqlExpr exportSpatialOperand(FunctionCall functionCall, Function function)
      throws UnsupportedRdbmsOperatorException {
