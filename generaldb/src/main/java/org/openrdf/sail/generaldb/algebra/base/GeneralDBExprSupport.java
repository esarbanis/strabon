...
public class GeneralDBExprSupport {
  ...
  public static GeneralDBSqlExpr relate(GeneralDBSqlExpr left, GeneralDBSqlExpr right,
      GeneralDBSqlExpr third) {
  ...
  public static GeneralDBSqlExpr geoBuffer(GeneralDBSqlExpr left, GeneralDBSqlExpr right,
      GeneralDBSqlExpr third, String resultType) {
  ...
  public static GeneralDBSqlExpr rccExternallyConnected(GeneralDBSqlExpr left,
      GeneralDBSqlExpr right) {
    return new GeneralDBSqlRCC8_Ec(left, right);
  }

  public static GeneralDBSqlExpr rccPartiallyOverlapping(GeneralDBSqlExpr left,
      GeneralDBSqlExpr right) {
    return new GeneralDBSqlRCC8_Po(left, right);
  }

  public static GeneralDBSqlExpr rccTangentialProperPartInverse(GeneralDBSqlExpr left,
      GeneralDBSqlExpr right) {
    return new GeneralDBSqlRCC8_Tppi(left, right);
  }

  public static GeneralDBSqlExpr rccTangentialProperPart(GeneralDBSqlExpr left,
      GeneralDBSqlExpr right) {
    return new GeneralDBSqlRCC8_Tpp(left, right);
  }

  public static GeneralDBSqlExpr rccNonTangentialProperPart(GeneralDBSqlExpr left,
      GeneralDBSqlExpr right) {
    return new GeneralDBSqlRCC8_Ntpp(left, right);
  }

  public static GeneralDBSqlExpr rccNonTangentialProperPartInverse(GeneralDBSqlExpr left,
      GeneralDBSqlExpr right) {
