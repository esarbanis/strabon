...
public class GeneralDBSqlEgenhofer_Contains extends GeneralDBSqlGeoSpatial{

	public GeneralDBSqlEgenhofer_Contains(GeneralDBSqlExpr left, GeneralDBSqlExpr right) {
		super(left, right);
	}
